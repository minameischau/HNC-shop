...
$(".input-group").on("click", ".button-plus", function (t) {
    ...
    (function () {
        ...
        if (
            ...
            noUiSlider.create(t, { connect: !0, behaviour: "tap", start: [49, 199], range: { min: [6], max: [300] }, format: wNumb({ decimals: 1, thousand: ".", prefix: "$" }) });
        ...
        if ($(".product").length > 1)
            tns({ container: "#product", items: 1, startIndex: 1, navContainer: "#productThumbnails", navAsThumbnails: !0, autoplay: !1, autoplayTimeout: 1500, swipeAngle: !1, speed: 1500, controls: !1, autoplayButtonOutput: !1 });
        if (
                ...
                $(".sidebar-nav-fixed a").on("click", function (t) {
                    if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                        ...
                        (e = e.length ? e : $("[name=" + this.hash.slice(1) + "]")).length &&
                            (t.preventDefault(),
                            $("html, body").animate({ scrollTop: e.offset().top - 90 }, 1e3, function () {
                                var t = $(e);
            ...
            $(".stopevent").length &&
                $(document).on("click.bs.collapse.data-api", ".stopevent", function (t) {
                    t.stopPropagation();
                }),
